...
namespace DriverInfo.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        {
            var user = ValidateUserCredential(authenticationRequestBody.UserName, authenticationRequestBody.Password);
        ...
        private DriverInfoUser ValidateUserCredential(string? userName, string? password)
        {
            ...
            // return a new DriverInfoUser (values would normally come from your user DB/table)
            return new DriverInfoUser(
                1,
                userName ?? "",
                "Zoltan",
                "Ujlaki",
